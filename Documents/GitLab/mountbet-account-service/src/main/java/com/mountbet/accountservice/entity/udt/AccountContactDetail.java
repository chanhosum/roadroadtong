 ...
 * @since 10/7/2018
 */
@UserDefinedType("contact_detail")
public class AccountContactDetail {
    ...
    @Column(value = "casino_nickname")
    @CassandraType(type = DataType.Name.TEXT)
    private String casinoNickname;

    @Column(value = "address_line_1")
    @CassandraType(type = DataType.Name.TEXT)
    private String addressLine1;

    @Column(value = "address_line_2")
    @CassandraType(type = DataType.Name.TEXT)
